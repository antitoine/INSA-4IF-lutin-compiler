...
void displayHelp() {
    ...
    cout << endl;
    cout << "SYNOPSIS" << endl;
    cout << "   lut [-" << ARG_DISPLAY_MEM << "][-" << ARG_ANALYSIS << "][-" << ARG_EXECUTION << "][-" <<
    ARG_OPTIMISATION << "] infile" << endl;
    cout << endl;
    ...
    cout << endl;
    cout << "OPTIONS" << endl;
    cout << "   -" << ARG_DISPLAY_MEM <<
    " : print the memory representation of the program, eventual errors printed on the standard error output" << endl;
    cout << "   -" << ARG_ANALYSIS <<
    " : static analysis of the program, extract errors on the standard error output" << endl;
    cout << "   -" << ARG_EXECUTION << " : interprete and execute each instructions of the program" << endl;
    cout << "   -" << ARG_OPTIMISATION <<
    " : simplification and optimisation of the program, if combined with -p only the tranformed program will be printed" <<
    endl;
