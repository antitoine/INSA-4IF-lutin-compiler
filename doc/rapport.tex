...
\afterpage{
	...
	\todo{Texte pour décrire l'automate}	
	
	\begin{figure}[H]
		\centering
		\includegraphics[height=0.9\textheight,width=1.0\textwidth,keepaspectratio]{figures/automate-LR-lutin.jpg}
...
\afterpage{
	...
	\todo{Texte pour décrire les transitions}	
...
\afterpage{
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1.05\textwidth,keepaspectratio]{../diagrams/class/lutin-compiler-class-diagram-uml.png}
